...
func (u paymentService) Create(ctx context.Context, payment models.Payment) (models.Payment, error) {
	...
	if payment.Student_id != "" {
		...
		student, err := u.storage.Student().GetByID(ctx, pKey.Id)
		if err != nil {
			return models.Payment{}, status.Error(codes.InvalidArgument, err.Error())
		}
...
func (u paymentService) GetAll(ctx context.Context, payment models.GetAllPaymentsRequest) (models.GetAllPaymentsResponse, error) {
