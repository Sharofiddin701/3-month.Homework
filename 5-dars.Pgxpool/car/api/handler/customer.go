...
// 	customers, err := h.Store.Customer().GetCustomerCars(request)
// 	if err != nil {
// 		handleResponse(c, "error while getting customers", http.StatusInternalServerError, err.Error())
// 		return
// 	}
...
// 	customer, err := h.Store.Customer().GetByIDCustomerCar(id)
// 	if err != nil {
...
// 	customer, err := h.Store.Customer().GetCustomerCarss(id)
// 	if err != nil {
// 		handleResponse(c, "error while getting customerCar by id", http.StatusInternalServerError, err.Error())
// 		return
// 	}
